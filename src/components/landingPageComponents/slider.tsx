        ...
        <div>
            ...
            >
                    ...
                    {sliderItemsData.map((item, index) => (
                        <CarouselItem
                            ...
                            className="
                                ...
                                py-6 px-4 md:px-8"
                        >
                            <div className="flex text-[var(--my-blue)] items-center gap-2">
                ...
                <div className="absolute top-[-3px] right-[50px] sm:static sm:top-auto sm:right-auto">
                    <CarouselPrevious className="flex text-white bg-[var(--my-blue)]" />
                    <CarouselNext className="flex text-white bg-[var(--my-blue)]" />
                </div>
            </Carousel>
        </div>
    );
